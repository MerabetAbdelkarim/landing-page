            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="">
                            <img src={LogoNav} className="h-8 me-3" alt="Fylo Logo" />
                            <br />
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                ...
                                <li className="flex gap-2">
                                    <img src={MailImg} width={'24px'} alt="" />
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {date} <a href="/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                    </span>
